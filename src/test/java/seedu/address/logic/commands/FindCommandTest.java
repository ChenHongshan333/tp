...
import static seedu.address.testutil.TypicalCats.*;
...
public class FindCommandTest {
    ...
    private CatContainsKeywordsPredicate preparePredicate(String userInput) {
        return new CatContainsKeywordsPredicate(
                Arrays.asList(userInput.trim().split("\\s+")), Collections.emptyList(), Collections.emptyList(), Collections.emptyList());
    }
